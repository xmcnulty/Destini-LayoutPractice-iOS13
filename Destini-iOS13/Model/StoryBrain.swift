...
struct StoryBrain {
    ...
    // title of current place in the story
    var currentTitle: String {
        return storyBoard[self.choiceIndex].title
    }
    
    var currentChoices: [StoryChoice] {
        return storyBoard[self.choiceIndex].getChoices()
    }
    
    mutating func choose(_ choice: StoryChoice) {
        self.choiceIndex = choice.desintaion
    }
}
